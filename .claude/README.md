...
### 神学框架
- **渐进启示**: 神的启示是渐进的，如希伯来书1:1-2所述
- **基督中心**: 神的儿子耶稣基督亲自启示，成为大祭司，新约永恒终极的救赎
- **信望爱**: 贯穿从创世到启示录主再来
- **爱永远长存**: 如今常存的有信有望有爱，其中最大的是爱
...
### 人物故事宝库
- **圣经人物谱系**: 从亚当到保罗，按救赎历史分期
- **通鉴人物谱系**: 从战国到唐，按朝代分期
- **三书人物对照**: 创业者、谋士、悲剧人物、忠臣、叛臣
- **六大叙事类型**: 英雄、悲剧、转化、救赎、忠心、悔改
...
├── WRITING_SOUL.md             # 写作灵魂：渐进启示与永恒之爱（新增）
├── settings.json                # 项目核心配置 + 神学框架 + Skills + Coworkers
├── coworkers.json              # 协作团队详细配置
├── CONTENT_RULES.md            # 内容质量规则
├── STYLE_GUIDE.md              # 代码与文档风格指南
├── commands/                   # AI Skills (v3.0 神学框架升级)
│   ├── master-editor.md        # Skill 1: 总编辑（四维透视评估）
│   ├── annotate.md             # Skill 2: 注疏师（救赎历史定位）
│   ├── ai-parallels.md         # Skill 3: AI战略家（信望爱框架）
│   ├── proofread.md            # Skill 4: 校对神（神学准确性检查）
│   └── publish.md              # Skill 5: 出书总管（三书合一主题）
└── prompts/                    # 自定义提示词
...
### v3.1.0 (2026-01-18)
- **新增** 人物故事宝库 (Character Treasury)
- **新增** 圣经人物谱系（10个时期）
- **新增** 通鉴人物谱系（6个朝代）
- **新增** 三书人物对照表（5大类型）
- **新增** 六大叙事类型模板
- **升级** `settings.json` 加入 `characterTreasury` 配置
- **升级** `master-editor.md` - 加入人物故事评估和叙事类型判断
- **升级** `annotate.md` - 加入人物注疏与对照功能
- **升级** `publish.md` - 加入人物故事宝库章节（周报/月报/年度书稿）

### v3.0.0 (2026-01-18)
- **新增** `WRITING_SOUL.md` - 写作灵魂配置文件
- **新增** 渐进启示神学框架 (Progressive Revelation)
- **新增** 信望爱 (Faith, Hope, Love) 主线
- **新增** 四维透视评估体系 (人性、出路、神的计划、争战)
- **新增** 爱永远长存作为终极主题
- **升级** `settings.json` 加入 `writingSoul` 核心神学配置
- **升级** `master-editor.md` - 加入四维透视评估和信望爱检验
- **升级** `annotate.md` - 加入救赎历史七阶段定位
- **升级** `ai-parallels.md` - 加入信望爱框架审视AI时代
- **升级** `proofread.md` - 加入神学准确性检查
- **升级** `publish.md` - 加入三书合一主题和爱永远长存结语
