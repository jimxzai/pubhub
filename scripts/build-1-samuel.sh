...
# 1 Samuel PDF Builder — standalone volume
# Uses the dedicated template: templates/pdf/1-samuel.latex

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(dirname "$SCRIPT_DIR")"
INPUT_DIR="$PROJECT_ROOT/books/bible/sam1-2-chroni1-2/1-samuel"
OUTPUT_DIR="$PROJECT_ROOT/output"
COMBINED_MD="$OUTPUT_DIR/1-samuel-combined.md"
OUTPUT_PDF="$OUTPUT_DIR/1-samuel.pdf"
TEMPLATE="$PROJECT_ROOT/templates/pdf/1-samuel.latex"
...
echo ""
echo "🔨 Generating PDF with dedicated template (1-samuel.latex)..."
