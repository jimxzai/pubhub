...
# 2 Samuel PDF Builder — standalone volume
# Uses the dedicated template: templates/pdf/2-samuel.latex

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(dirname "$SCRIPT_DIR")"
INPUT_DIR="$PROJECT_ROOT/books/bible/sam1-2-chroni1-2/2-samuel"
OUTPUT_DIR="$PROJECT_ROOT/output"
COMBINED_MD="$OUTPUT_DIR/2-samuel-combined.md"
OUTPUT_PDF="$OUTPUT_DIR/2-samuel.pdf"
TEMPLATE="$PROJECT_ROOT/templates/pdf/2-samuel.latex"

echo "=========================================="
echo "📖 2 Samuel PDF (standalone volume)"
echo "=========================================="
echo ""
...
echo ""
echo "🔨 Generating PDF with dedicated template (2-samuel.latex)..."
